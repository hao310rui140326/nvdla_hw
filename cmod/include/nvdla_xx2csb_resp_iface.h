...
// File Name: nvdla_xx2csb_resp_iface.h

#if !defined(_nvdla_xx2csb_resp_iface_H_)
#define _nvdla_xx2csb_resp_iface_H_
...
union nvdla_xx2csb_resp_u {
    xx2csb_rd_erpt_t xx2csb_rd_erpt;
    xx2csb_wr_erpt_t xx2csb_wr_erpt;
};
typedef struct nvdla_xx2csb_resp_s {
    union nvdla_xx2csb_resp_u pd ; 
    uint8_t tag;
} nvdla_xx2csb_resp_t;

#endif // !defined(_nvdla_xx2csb_resp_iface_H_)
